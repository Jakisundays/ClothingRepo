...
export const productCategories = [
  ...
  //     {
  //       title: "Camisetas",
  //       description: "Camisetas casuales y cómodas para el uso diario.",
  //       image: "/images/camiseta-uno.jpg",
  //       slug: "camisetas",
  //     },
  //     {
  //       title: "Jeans",
  //       description:
  //         "Pantalones de mezclilla clásicos en varios estilos y lavados.",
  //       image: "/images/jeans-uno.jpg",
  //       slug: "jeans",
  //     },
  //     {
  //       title: "Vestidos",
  //       description:
  //         "Vestidos elegantes y con estilo para diferentes ocasiones.",
  //       image: "/images/vestido-uno.jpg",
  //       slug: "vestidos",
  //     },
  //     {
  //       title: "Sudaderas",
  //       description: "Sudaderas cálidas y acogedoras para el clima fresco.",
  //       image: "/images/sudadera-uno.jpg",
  //       slug: "sudaderas",
  //     },
  //     {
  //       title: "Zapatillas",
  //       description: "Opciones de calzado para diversas actividades y estilos.",
  //       image: "/images/zapatilla-uno.jpg",
  //       slug: "zapatillas",
  //     },
  //     {
  //       title: "Accesorios",
  //       description: "Accesorios de moda para complementar tu atuendo.",
  //       image: "/images/accesorio-uno.jpg",
  //       slug: "accesorios",
  //     },
  //     {
  //       title: "Abrigos",
  //       description:
  //         "Chaquetas y abrigos para mantenerte abrigado en las estaciones más frías.",
  //       image: "/images/abrigo-uno.jpg",
  //       slug: "abrigos",
  //     },
  //   ],
  // },
