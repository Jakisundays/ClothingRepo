    ...
    <footer className="w-full border-t bg-background">
      <Shell>
        ...
        <section
          ...
          className="flex items-center space-x-4 justify-around md:justify-start"
        >
          <div className="flex-1 text-left text-sm leading-loose text-muted-foreground hidden md:block">
            Built by{" "}
            <Link
